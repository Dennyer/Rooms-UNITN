...
def date_room_hedquarter_keyboard(code, room):
    keyboard = [[InlineKeyboardButton(DT["dateButton"], callback_data="date;create;" + str(code) + ";" + str(room))],
                [InlineKeyboardButton(DT["todayButton"],
                                      callback_data="room;selroomtoday;" + str(code) + ";" + str(room))],
                [InlineKeyboardButton(DT["backButton"], callback_data="headquarter;sel;" + str(code))]]
    return InlineKeyboardMarkup(keyboard)
